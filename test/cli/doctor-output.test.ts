...
describe("formatHookDoctorReport", () => {
  it("omits disabled integrations from text output", () => {
    ...
    expect(formatHookDoctorReport(report)).toBe([
      ...
      "",
      "available integrations: aider, avante, codex, claude-code, cline, codebuddy, continue, cursor, droid, gemini-cli, junie, kilo, openhands, pi, roo, vscode-copilot, windsurf, zed, copilot-cli",
