...
import { doctorGrokBotRule } from "../grok-bot/index.js";
...
import type { GrokBotDoctorReport, GrokBotRuleOptions } from "../grok-bot/index.js";
...
const hookDoctorIntegrationDoctors = {
  ...
  "grok-bot": (options) => doctorGrokBotRule(undefined, getHookCommandOptions(options)),
