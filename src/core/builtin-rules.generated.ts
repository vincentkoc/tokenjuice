...
import rule29 from "../rules/filesystem/fd.json" with { type: "json" };
import rule30 from "../rules/filesystem/find.json" with { type: "json" };
import rule31 from "../rules/filesystem/git-ls-files.json" with { type: "json" };
import rule32 from "../rules/filesystem/ls.json" with { type: "json" };
import rule33 from "../rules/filesystem/rg-files.json" with { type: "json" };
import rule34 from "../rules/generic/fallback.json" with { type: "json" };
import rule35 from "../rules/generic/help.json" with { type: "json" };
import rule36 from "../rules/git/branch.json" with { type: "json" };
import rule37 from "../rules/git/diff-name-only.json" with { type: "json" };
import rule38 from "../rules/git/diff-stat.json" with { type: "json" };
import rule39 from "../rules/git/diff.json" with { type: "json" };
import rule40 from "../rules/git/log-oneline.json" with { type: "json" };
import rule41 from "../rules/git/remote-v.json" with { type: "json" };
import rule42 from "../rules/git/show.json" with { type: "json" };
...
export const BUNDLED_BUILTIN_RULES: JsonRule[] = [
  ...
  rule29 as JsonRule, // rules/filesystem/fd.json
  rule30 as JsonRule, // rules/filesystem/find.json
  rule31 as JsonRule, // rules/filesystem/git-ls-files.json
  rule32 as JsonRule, // rules/filesystem/ls.json
  rule33 as JsonRule, // rules/filesystem/rg-files.json
  rule34 as JsonRule, // rules/generic/fallback.json
  rule35 as JsonRule, // rules/generic/help.json
  rule36 as JsonRule, // rules/git/branch.json
  rule37 as JsonRule, // rules/git/diff-name-only.json
  rule38 as JsonRule, // rules/git/diff-stat.json
  rule39 as JsonRule, // rules/git/diff.json
  rule40 as JsonRule, // rules/git/log-oneline.json
  rule41 as JsonRule, // rules/git/remote-v.json
  rule42 as JsonRule, // rules/git/show.json
