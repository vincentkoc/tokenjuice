...
describe("formatHookDoctorReport", () => {
  it("omits disabled integrations from text output", () => {
    ...
    expect(formatHookDoctorReport(report)).toBe([
      ...
      "",
      "available integrations: aider, amazon-q, amp, antigravity, augment, avante, codex, claude-code, cline, codebuddy, continue, copilot-agent, crush, cursor, devin, droid, firebase-studio, gemini-cli, goose, grok-build, grok-cli, junie, kimi, kiro, kilo, mistral-vibe, openhands, open-interpreter, openwebui, pi, plandex, qoder, qwen-code, replit, roo, ruler, trae, vscode-copilot, warp, windsurf, zed, copilot-cli",
